...
## Ordered Backups
**Note:** There is no verified third independent external pool for this milestone.
...
## Root Codex
- **Standard pool**: Weekly 93% remaining, 5-hour unavailable, PROHIBITED for implementation.
- **Spark pool**: Weekly 100% remaining, 5-hour 100% remaining, reachable but NOT USED.
- **Paid credits**: 0.
- **Reset credits**: 0.
